...
class Fconv_PCA(nn.Module):
    ...
    def __init__(self,  sizeP, inNum, outNum, tranNum=8, inP = None, padding=None, ifIni=0, bias=True, Smooth = True, iniScale = 0.4):
...
class ResBlock(nn.Module):
    def __init__(
        ...
        bias=True, bn=False, act=nn.ReLU(True), res_scale=1,  Smooth = True, iniScale = 0.4):
